...
import 'package:loyalty_points_app/widgets/product_widget.dart';
                      ...
                      child: ListTile(
                        title:  Padding(
                          ...
                          child: Container(
                            ...
                            child: ClipOval(
                              child: FadeInImage.memoryNetwork(placeholder: kTransparentImage, image: categoryModel.image,fit: BoxFit.cover,),//this is the logon is stored
                            ),
                          ),
                        ),
                        subtitle: Container(
                          alignment: Alignment.topCenter,
                          child: Text(categoryModel.name),// Where caption is stored
                        ),
                      ),
                    ),
                  ),
